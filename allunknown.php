	...
	<body>
		<br><br>
		<h1 class="heading">Unknown Points List</h1>
		<div align="center">List of All Unknown Points in the Database</div>
		<br>
		<?php
		...
		$sql = 'SELECT * FROM datapoint WHERE type="unknown"
		ORDER BY id';
